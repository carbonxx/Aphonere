...
classifier = Classifier("D:\ISL-main\Aphonere\Model\M4_model\keras_model.h5",
                        "D:\ISL-main\Aphonere\Model\M4_model\labels.txt")

offset = 20
imgSize = 300
labels = ["Bye", "Excuse me", "Good", "Nice to meet", "You", "V", "I", "S", "H", "N", "U"]
