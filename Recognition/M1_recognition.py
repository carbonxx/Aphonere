...
classifier = Classifier("D:\ISL-main\Aphonere\Model\M1_model\keras_model.h5", "D:\ISL-main\Aphonere\Model\M1_model\labels.txt")

offset = 20
imgSize = 300
labels = ["Good", "Hello", "How are you", "Im", "Namaste", "Okay"]
