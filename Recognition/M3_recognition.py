...
classifier = Classifier("D:\ISL-main\Aphonere\Model\M3_model\keras_model.h5",
                        "D:\ISL-main\Aphonere\Model\M3_model\labels.txt")

offset = 20
imgSize = 300
labels = ["Im", "Please", "Thank you", "Sorry", "P", "R", "E", "K", "S", "H", "A"]
