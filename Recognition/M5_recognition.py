...
classifier = Classifier("D:\ISL-main\Aphonere\Model\M5_model\keras_model.h5",
                        "D:\ISL-main\Aphonere\Model\M5_model\labels.txt")

offset = 20
imgSize = 300
labels = ["Mon", "Tues", "Wednes", "Thurs", "Fri", "Satur", "Sun", "Day"]
