...
G.add_edges_from([('', 'A'), ('', 'B'), ('', 'C'), ('', 'D'), ('', 'E'), ('', 'F'), ('', 'G'), ('', 'H'), ('', 'I'),
                  ...
                  ('G', 'Q'), ('G', 'R'), ('G', 'S'), ('G', 'T'), ('G', 'U'), ('G', 'V'), ('G', 'W'), ('G', 'X'),
                  ('G', 'Y'), ('G', 'Z'),
                  ...
                  ('I', 'I'),('I', 'J'), ('I', 'K'), ('I', 'L'), ('I', 'M'),('I', 'N'), ('I', 'O'), ('I', 'P'),
                  ('I', 'Q'), ('I', 'R'), ('I', 'S'), ('I', 'T'), ('I', 'U'), ('I', 'V'), ('I', 'W'), ('I', 'X'),
                  ('I', 'Y'), ('I', 'Z'),

                  ('J', 'A'), ('J', 'B'), ('J', 'C'), ('J', 'D'), ('J', 'E'), ('J', 'F'), ('J', 'G'), ('J', 'H'),
                  ('J', 'I'), ('J', 'J'), ('J', 'K'), ('J', 'L'), ('J', 'M'),('J', 'N'), ('J', 'O'), ('J', 'P'),
                  ('J', 'Q'), ('J', 'R'), ('J', 'S'), ('J', 'T'), ('J', 'U'), ('J', 'V'), ('J', 'W'), ('J', 'X'),
                  ('J', 'Y'), ('J', 'Z'),

                  ('K', 'A'), ('K', 'B'), ('K', 'C'), ('K', 'D'), ('K', 'E'), ('K', 'F'), ('K', 'G'), ('K', 'H'),
                  ('K', 'I'), ('K', 'J'), ('K', 'K'), ('K', 'L'), ('K', 'M'),('K', 'N'), ('K', 'O'), ('K', 'P'),
                  ('K', 'Q'), ('K', 'R'), ('K', 'S'), ('K', 'T'), ('K', 'U'), ('K', 'V'), ('K', 'W'), ('K', 'X'),
                  ('K', 'Y'), ('K', 'Z'),
                  ...
                  ('N', 'Q'), ('N', 'R'), ('N', 'S'), ('N', 'T'), ('N', 'U'), ('N', 'V'), ('N', 'W'), ('N', 'X'),
                  ('N', 'Y'), ('N', 'Z'),

                  ('O', 'A'), ('O', 'B'), ('O', 'C'), ('O', 'D'), ('O', 'E'), ('O', 'F'), ('O', 'G'), ('O', 'H'),
                  ('O', 'I'), ('O', 'J'), ('O', 'K'), ('O', 'L'), ('O', 'M'),('O', 'N'), ('O', 'O'), ('O', 'P'),
                  ('O', 'Q'), ('O', 'R'), ('O', 'S'), ('O', 'T'), ('O', 'U'), ('O', 'V'), ('O', 'W'), ('O', 'X'),
                  ('O', 'Y'), ('O', 'Z'),
                  ...
                  ('Q', 'Q'), ('Q', 'R'), ('Q', 'S'), ('Q', 'T'), ('Q', 'U'), ('Q', 'V'), ('Q', 'W'), ('Q', 'X'),
                  ('Q', 'Y'), ('Q', 'Z'),
                  ...
                  ('V', 'Q'), ('V', 'R'), ('V', 'S'), ('V', 'T'), ('V', 'U'), ('V', 'V'), ('V', 'W'), ('V', 'X'),
                  ('V', 'Y'), ('V', 'Z'),

                  ('W', 'A'), ('W', 'B'), ('W', 'C'), ('W', 'D'), ('W', 'E'), ('W', 'F'), ('W', 'G'), ('W', 'H'),
                  ('W', 'I'), ('W', 'J'), ('W', 'K'), ('W', 'L'), ('W', 'M'),('W', 'N'), ('W', 'O'), ('W', 'P'),
                  ('W', 'Q'), ('W', 'R'), ('W', 'S'), ('W', 'T'), ('W', 'U'), ('W', 'V'), ('W', 'W'), ('W', 'X'),
                  ('W', 'Y'), ('W', 'Z'),
                  ...
                  ('Y', 'I'), ('Y', 'J'), ('Y', 'K'), ('Y', 'L'), ('Y', 'M'),('Y', 'N'), ('Y', 'O'), ('Y', 'P'),
                  ('Y', 'Q'), ('Y', 'R'), ('Y', 'S'), ('Y', 'T'), ('Y', 'U'), ('Y', 'V'), ('Y', 'W'), ('Y', 'X'),
                  ('Y', 'Y'), ('Y', 'Z'),

                  ('Z', 'A'), ('Z', 'B'), ('Z', 'C'), ('Z', 'D'), ('Z', 'E'), ('Z', 'F'), ('Z', 'G'), ('Z', 'H'),
                  ('Z', 'I'), ('Z', 'J'), ('Z', 'K'), ('Z', 'L'), ('Z', 'M'),('Z', 'N'), ('Z', 'O'), ('Z', 'P'),
                  ('Z', 'Q'), ('Z', 'R'), ('Z', 'S'), ('Z', 'T'), ('Z', 'U'), ('Z', 'V'), ('Z', 'W'), ('Z', 'X'),
                  ('Z', 'Y'), ('Z', 'Z')
...
# path = input("Enter path to check: ").split()
with open('Translation\input.txt', 'r') as f:
